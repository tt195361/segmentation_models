...
from .fpn import FPNBlock, Conv3x3BnReLU, DoubleConv3x3BnReLU
...
def build_ppm(
    ...
    x4 = SpatialContextBlock(4, conv_filters, pooling_type, use_batchnorm)(x)
    ...
    x = layers.Concatenate(axis=concat_axis, name='psp_concat')([x, x1, x2, x4, x6])
...
def build_uper_decoder(
    ...
    ppm_output = build_ppm(ppm_input, psp_pooling_type, psp_conv_filters, psp_use_batchnorm)
